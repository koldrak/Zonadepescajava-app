...
public class CardImageResolver {
    ...
    private void seedExplicitMap() {
        ...
        explicitMap.put(CardId.CANGREJO_DECORADOR, "cangrejodecorador.png");
        explicitMap.put(CardId.CANGREJO_ERMITANO, "cangrejoermitaño.png");
        explicitMap.put(CardId.CANGREJO_ROJO, "cangrejorojo.png");
        explicitMap.put(CardId.CANGREJO_HERRADURA, "cangrejoherradura.png");
        explicitMap.put(CardId.CANGREJO_VIOLINISTA, "cangrejoviolinista .png");
        explicitMap.put(CardId.CENTOLLA, "centolla.png");
        explicitMap.put(CardId.COPEPODO_BRILLANTE, "bopepodobrillante.png");
        explicitMap.put(CardId.KOI, "koi.png");
        explicitMap.put(CardId.KRILL, "krill.png");
        explicitMap.put(CardId.BOGAVANTE, "bogavante.png");
        explicitMap.put(CardId.JAIBA_GIGANTE_DE_COCO, "jaibagigantedecoco.png");
        ...
        explicitMap.put(CardId.LOCO, "loco.png");
        ...
        explicitMap.put(CardId.OSTRAS, "ostras.png");
